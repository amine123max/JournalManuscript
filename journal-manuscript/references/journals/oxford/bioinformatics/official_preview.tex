...
\begin{document}
\begin{center}
{\LARGE\bfseries Bioinformatics}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Academic press journal format with classic metadata}\par
\vspace{0.2em}
{\footnotesize Profile slug: bioinformatics \quad Family: oxford \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
