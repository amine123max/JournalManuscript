...
\begin{document}
\begin{center}
{\LARGE\bfseries Bioinspiration and Biomimetics}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Physics and measurement-oriented journal layout}\par
\vspace{0.2em}
{\footnotesize Profile slug: bioinspiration-and-biomimetics \quad Family: iop \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
