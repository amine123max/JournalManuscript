...
\begin{document}
\begin{center}
{\LARGE\bfseries Complexity}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Template with publisher statements and metadata}\par
\vspace{0.2em}
{\footnotesize Profile slug: hindawi-complexity \quad Family: hindawi \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
