# Hindawi Family Profile

Use this profile when the target manuscript follows the Hindawi Family template family.
...
- Downloaded guide file: `assets/official-templates/guides/hindawi/official-guide-source.html`
- Guide alignment: use this local guide file as the nearest official reference before calling the layout submission-ready

- Common template anchor: Hindawi or Wiley-Hindawi templates
- Common traits: metadata-heavy submission packages and publisher-defined declarations
