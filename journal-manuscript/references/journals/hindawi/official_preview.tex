...
\begin{document}
\begin{center}
{\LARGE\bfseries Hindawi Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for Hindawi Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: hindawi \quad Family: hindawi \quad Scope: Family baseline}
\end{center}
\vspace{0.2em}
\noindent{\color{orange!65!black}\bfseries Article Type:} Placeholder Research Article\par\vspace{0.4em}
