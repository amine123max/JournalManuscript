...
\begin{document}
\begin{flushleft}
{\huge\bfseries Cell}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Editorial life-science manuscript preview}\par
\vspace{0.2em}
{\footnotesize Profile slug: cell \quad Family: cell-press \quad Scope: Specific journal profile}
\end{flushleft}
\vspace{0.2em}
