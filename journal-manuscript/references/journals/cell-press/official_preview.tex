...
\begin{document}
\begin{flushleft}
{\huge\bfseries Cell Press Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for Cell Press Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: cell-press \quad Family: cell-press \quad Scope: Family baseline}
\end{flushleft}
\vspace{0.2em}
\noindent{\color{black}\bfseries Article Type:} Placeholder Research Article\par\vspace{0.4em}
