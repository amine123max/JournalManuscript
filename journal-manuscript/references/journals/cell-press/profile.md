# Cell Press Family Profile

Use this profile when the target manuscript follows the Cell Press Family template family.
...
- Downloaded guide file: `assets/official-templates/guides/cell-press/official-guide-source.html`
- Guide alignment: use this local guide file as the nearest official reference before calling the layout submission-ready

- Common template anchor: Cell Press journal templates
- Common traits: strong front matter control, graphical or visual requirements, and editorial end sections
