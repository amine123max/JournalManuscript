...
\begin{document}
\begin{flushleft}
{\huge\bfseries Science Robotics}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize AAAS robotics article preview}\par
\vspace{0.2em}
{\footnotesize Profile slug: science-robotics \quad Family: aaas \quad Scope: Specific journal profile}
\end{flushleft}
\vspace{0.2em}
