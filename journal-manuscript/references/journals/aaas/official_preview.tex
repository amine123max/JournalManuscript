...
\begin{document}
\begin{flushleft}
{\huge\bfseries AAAS Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for AAAS Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: aaas \quad Family: aaas \quad Scope: Family baseline}
\end{flushleft}
\vspace{0.2em}
