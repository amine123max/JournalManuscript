...
Use this profile when the target manuscript follows the AAAS Family template family.
...
- Downloaded guide file: `assets/official-templates/guides/aaas/official-guide-source.html`
- Guide alignment: use this local guide file as the nearest official reference before calling the layout submission-ready

- Common template anchor: AAAS journal templates
- Common traits: highly editorialized manuscript structure, strict figure preparation, and submission-specific metadata
