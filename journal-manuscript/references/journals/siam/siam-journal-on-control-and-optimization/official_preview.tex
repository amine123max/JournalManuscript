...
\begin{document}
\begin{center}
{\LARGE\bfseries SIAM Journal on Control and Optimization}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Optimization journal preview with theorem block}\par
\vspace{0.2em}
{\footnotesize Profile slug: siam-journal-on-control-and-optimization \quad Family: siam \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
