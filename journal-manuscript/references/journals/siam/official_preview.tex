...
\begin{document}
\begin{center}
{\LARGE\bfseries SIAM Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for SIAM Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: siam \quad Family: siam \quad Scope: Family baseline}
\end{center}
\vspace{0.2em}
\noindent{\color{blue!70!black}\bfseries Article Type:} Placeholder Research Article\par\vspace{0.4em}
