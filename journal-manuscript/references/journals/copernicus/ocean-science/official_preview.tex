...
\begin{document}
\begin{flushleft}
{\LARGE\bfseries Ocean Science}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Geoscience manuscript with open-review lineage}\par
\vspace{0.2em}
{\footnotesize Profile slug: ocean-science \quad Family: copernicus \quad Scope: Specific journal profile}
\end{flushleft}
\vspace{0.2em}
