...
\begin{document}
\begin{flushleft}
{\LARGE\bfseries SAGE Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for SAGE Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: sage \quad Family: sage \quad Scope: Family baseline}
\end{flushleft}
\vspace{0.2em}
\noindent{\color{green!45!black}\bfseries Article Type:} Placeholder Research Article\par\vspace{0.4em}
