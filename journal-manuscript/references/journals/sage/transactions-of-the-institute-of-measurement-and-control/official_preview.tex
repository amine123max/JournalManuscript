...
\begin{document}
\begin{flushleft}
{\LARGE\bfseries Transactions of the Institute of Measurement and Control}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Publisher-specific title page and citation conventions}\par
\vspace{0.2em}
{\footnotesize Profile slug: transactions-of-the-institute-of-measurement-and-control \quad Family: sage \quad Scope: Specific journal profile}
\end{flushleft}
\vspace{0.2em}
