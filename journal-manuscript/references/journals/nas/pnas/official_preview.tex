...
\begin{document}
\begin{center}
{\LARGE\bfseries Proceedings of the National Academy of Sciences}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize PNAS-style article with significance statement}\par
\vspace{0.2em}
{\footnotesize Profile slug: pnas \quad Family: nas \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
