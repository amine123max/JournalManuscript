...
Use this profile when the target manuscript follows the NAS Family template family.
...
- Downloaded guide file: `assets/official-templates/guides/nas/official-guide-source.html`
- Guide alignment: use this local guide file as the nearest official reference before calling the layout submission-ready

- Common template anchor: PNAS or NAS-provided templates
- Common traits: broad-science manuscript structure, significance statements, and journal metadata
