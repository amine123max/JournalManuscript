...
\begin{document}
\begin{center}
{\LARGE\bfseries NAS Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for NAS Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: nas \quad Family: nas \quad Scope: Family baseline}
\end{center}
\vspace{0.2em}
\noindent{\color{red!50!black}\bfseries Article Type:} Placeholder Research Article\par\vspace{0.4em}
...
\noindent \textbf{Significance.} This placeholder preview emphasizes how a short editorial statement may appear near the front matter.\par
\vspace{0.5em}
