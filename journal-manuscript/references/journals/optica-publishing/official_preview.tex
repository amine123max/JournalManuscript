...
\begin{document}
\begin{center}
{\LARGE\bfseries Optica Publishing Group Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for Optica Publishing Group Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: optica-publishing \quad Family: optica-publishing \quad Scope: Family baseline}
\end{center}
\vspace{0.2em}
\noindent{\color{blue!65!black}\bfseries Article Type:} Placeholder Research Article\par\vspace{0.4em}
