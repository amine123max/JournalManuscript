...
\begin{document}
\begin{center}
{\LARGE\bfseries Journal of Marine Science and Engineering}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Marine engineering journal preview}\par
\vspace{0.2em}
{\footnotesize Profile slug: journal-of-marine-science-and-engineering \quad Family: mdpi \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
