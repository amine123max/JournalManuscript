...
\begin{document}
\begin{center}
{\LARGE\bfseries Applied Sciences}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Metadata-rich open-access journal layout}\par
\vspace{0.2em}
{\footnotesize Profile slug: applied-sciences \quad Family: mdpi \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
