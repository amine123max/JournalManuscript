...
\begin{document}
\begin{center}
{\LARGE\bfseries Sensors}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Sensor journal article with declarations}\par
\vspace{0.2em}
{\footnotesize Profile slug: sensors \quad Family: mdpi \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
