...
\begin{document}
\begin{center}
{\LARGE\bfseries Machines}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize MDPI engineering journal with declaration-rich metadata}\par
\vspace{0.2em}
{\footnotesize Profile slug: machines \quad Family: mdpi \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
