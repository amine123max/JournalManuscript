...
\begin{document}
\begin{center}
{\LARGE\bfseries Robotics}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize MDPI robotics journal with declaration-rich metadata}\par
\vspace{0.2em}
{\footnotesize Profile slug: robotics \quad Family: mdpi \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
