...
\usepackage{array}
\usepackage{cite}
\title{IEEE Transactions on Industrial Informatics\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Transactions on Industrial Informatics}
\begin{document}
\maketitle
\begin{abstract}
