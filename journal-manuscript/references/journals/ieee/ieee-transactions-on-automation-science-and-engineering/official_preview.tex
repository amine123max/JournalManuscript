...
\usepackage{array}
\usepackage{cite}
\title{IEEE Transactions on Automation Science and Engineering\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Transactions on Automation Science and Engineering}
\begin{document}
\maketitle
\begin{abstract}
