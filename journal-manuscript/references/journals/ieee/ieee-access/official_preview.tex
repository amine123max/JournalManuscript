...
\usepackage{array}
\usepackage{cite}
\title{IEEE Access\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Access}
\begin{document}
\maketitle
\begin{abstract}
