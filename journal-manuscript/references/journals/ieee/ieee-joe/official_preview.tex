...
\usepackage{array}
\usepackage{cite}
\title{IEEE Journal of Oceanic Engineering\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Journal of Oceanic Engineering}
\begin{document}
\maketitle
\begin{abstract}
