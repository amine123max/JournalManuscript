...
\usepackage{array}
\usepackage{cite}
\title{IEEE Journal of Selected Topics in Applied Earth Observations and Remote Sensing\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Journal of Selected Topics in Applied Earth Observations and Remote Sensing}
\begin{document}
\maketitle
\begin{abstract}
