...
\usepackage{array}
\usepackage{cite}
\title{IEEE Family Baseline\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Family Baseline}
\begin{document}
\maketitle
\begin{abstract}
