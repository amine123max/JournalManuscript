...
\usepackage{array}
\usepackage{cite}
\title{IEEE Transactions on Instrumentation and Measurement\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Transactions on Instrumentation and Measurement}
\begin{document}
\maketitle
\begin{abstract}
