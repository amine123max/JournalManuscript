...
\usepackage{array}
\usepackage{cite}
\title{IEEE Transactions on Pattern Analysis and Machine Intelligence\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Transactions on Pattern Analysis and Machine Intelligence}
\begin{document}
\maketitle
\begin{abstract}
