...
\usepackage{array}
\usepackage{cite}
\title{IEEE Robotics and Automation Letters\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Robotics and Automation Letters}
\begin{document}
\maketitle
\begin{abstract}
