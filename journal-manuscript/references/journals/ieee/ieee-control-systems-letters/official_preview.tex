...
\usepackage{array}
\usepackage{cite}
\title{IEEE Control Systems Letters\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Control Systems Letters}
\begin{document}
\maketitle
\begin{abstract}
