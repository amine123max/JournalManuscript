...
\usepackage{array}
\usepackage{cite}
\title{IEEE Transactions on Neural Networks and Learning Systems\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Transactions on Neural Networks and Learning Systems}
\begin{document}
\maketitle
\begin{abstract}
