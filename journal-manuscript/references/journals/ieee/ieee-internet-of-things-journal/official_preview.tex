...
\usepackage{array}
\usepackage{cite}
\title{IEEE Internet of Things Journal\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Internet of Things Journal}
\begin{document}
\maketitle
\begin{abstract}
