...
\usepackage{array}
\usepackage{cite}
\title{IEEE Transactions on Geoscience and Remote Sensing\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Transactions on Geoscience and Remote Sensing}
\begin{document}
\maketitle
\begin{abstract}
