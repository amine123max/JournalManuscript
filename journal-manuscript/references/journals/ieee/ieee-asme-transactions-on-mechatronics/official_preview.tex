...
\usepackage{array}
\usepackage{cite}
\title{IEEE/ASME Transactions on Mechatronics\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE/ASME Transactions on Mechatronics}
\begin{document}
\maketitle
\begin{abstract}
