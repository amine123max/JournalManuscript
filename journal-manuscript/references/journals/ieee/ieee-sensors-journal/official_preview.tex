...
\usepackage{array}
\usepackage{cite}
\title{IEEE Sensors Journal\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Sensors Journal}
\begin{document}
\maketitle
\begin{abstract}
