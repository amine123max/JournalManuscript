...
\usepackage{array}
\usepackage{cite}
\title{IEEE Transactions on Systems, Man, and Cybernetics: Systems\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Transactions on Systems, Man, and Cybernetics: Systems}
\begin{document}
\maketitle
\begin{abstract}
