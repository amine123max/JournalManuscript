...
\usepackage{array}
\usepackage{cite}
\title{IEEE Transactions on Control Systems Technology\\\large Submission Preview Derived from the IEEE Journal Sample}
...
\markboth{IEEE Journal Template Library,~2026}{Template Library: IEEE Transactions on Control Systems Technology}
\begin{document}
\maketitle
\begin{abstract}
