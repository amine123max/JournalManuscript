...
Use this profile when the target manuscript follows the ACM Family template family.
...
- Guide alignment: Use this family baseline only when the exact ACM target journal has not yet been fixed; once the venue is known, tighten the manuscript against that journal's live ACM guidance.

- Common template anchor: ACM article templates or journal formats
- Common traits: ACM reference style, author metadata handling, and template-specific front matter
