...
\begin{document}
\begin{center}
{\LARGE\bfseries Taylor and Francis Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for Taylor and Francis Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: taylor-francis \quad Family: taylor-francis \quad Scope: Family baseline}
\end{center}
\vspace{0.2em}
\noindent{\color{cyan!55!black}\bfseries Article Type:} Placeholder Research Article\par\vspace{0.4em}
