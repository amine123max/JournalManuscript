...
\begin{document}
\begin{center}
{\LARGE\bfseries International Journal of Control}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Journal manuscript with review-copy style influences}\par
\vspace{0.2em}
{\footnotesize Profile slug: international-journal-of-control \quad Family: taylor-francis \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
