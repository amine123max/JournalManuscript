...
\begin{document}
\begin{center}
{\LARGE\bfseries Custom Journal Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for Custom Journal Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: custom-journal \quad Family: custom-journal \quad Scope: Family baseline}
\end{center}
\vspace{0.2em}
