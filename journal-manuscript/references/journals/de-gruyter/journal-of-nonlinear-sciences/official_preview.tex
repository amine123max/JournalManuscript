...
\begin{document}
\begin{center}
{\LARGE\bfseries Journal of Nonlinear Sciences}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Academic press manuscript with classic metadata}\par
\vspace{0.2em}
{\footnotesize Profile slug: journal-of-nonlinear-sciences \quad Family: de-gruyter \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
