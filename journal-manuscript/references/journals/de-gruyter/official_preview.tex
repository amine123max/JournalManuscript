...
\begin{document}
\begin{center}
{\LARGE\bfseries De Gruyter Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for De Gruyter Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: de-gruyter \quad Family: de-gruyter \quad Scope: Family baseline}
\end{center}
\vspace{0.2em}
\noindent{\color{gray!65!black}\bfseries Article Type:} Placeholder Research Article\par\vspace{0.4em}
