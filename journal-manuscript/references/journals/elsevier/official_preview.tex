...
\begin{document}
\begin{flushleft}
{\LARGE\bfseries Elsevier Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for Elsevier Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: elsevier \quad Family: elsevier \quad Scope: Family baseline}
\end{flushleft}
\vspace{0.2em}
\noindent{\color{orange!55!black}\bfseries Article Type:} Placeholder Research Article\par\vspace{0.4em}
\noindent\textbf{Highlights.} Template-aware placeholder layout. Figure and table spacing preview. Journal-specific front-matter simulation.\par\vspace{0.5em}
\noindent\textbf{Graphical Abstract.}\par\begin{center}\fcolorbox{black!55}{gray!12}{\begin{minipage}[c][2.4cm][c]{0.86\linewidth}\centering Graphical abstract placeholder\end{minipage}}\end{center}\vspace{0.4em}
