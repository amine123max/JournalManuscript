...
\begin{document}
\begin{center}
{\LARGE\bfseries Frontiers Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for Frontiers Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: frontiers \quad Family: frontiers \quad Scope: Family baseline}
\end{center}
\vspace{0.2em}
\noindent{\color{magenta!55!black}\bfseries Article Type:} Placeholder Research Article\par\vspace{0.4em}
...
\noindent \textbf{Specialty Section.} Robotics and Autonomous Systems.\par
\noindent \textbf{Correspondence.} corresponding.author@example.org\par
