...
\begin{document}
\begin{center}
{\LARGE\bfseries Frontiers in Robotics and AI}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Specialty-led open-access submission format}\par
\vspace{0.2em}
{\footnotesize Profile slug: frontiers-in-robotics-and-ai \quad Family: frontiers \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
