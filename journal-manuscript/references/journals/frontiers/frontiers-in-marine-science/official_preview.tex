...
\begin{document}
\begin{center}
{\LARGE\bfseries Frontiers in Marine Science}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Specialty-led open-access submission format}\par
\vspace{0.2em}
{\footnotesize Profile slug: frontiers-in-marine-science \quad Family: frontiers \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
