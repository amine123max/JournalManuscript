...
\begin{document}
\begin{center}
{\LARGE\bfseries Cambridge Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for Cambridge Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: cambridge \quad Family: cambridge \quad Scope: Family baseline}
\end{center}
\vspace{0.2em}
\noindent{\color{brown!55!black}\bfseries Article Type:} Placeholder Research Article\par\vspace{0.4em}
...
\vspace{0.5em}\noindent\fcolorbox{black!55}{gray!8}{\parbox{0.96\linewidth}{\textbf{Theorem 1.} Placeholder theorem-style block used to preview theorem-heavy journal layouts.}}\par\vspace{0.5em}
