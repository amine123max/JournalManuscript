...
\begin{document}
\begin{center}
{\LARGE\bfseries Journal of Fluid Mechanics}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Mechanics journal with equation-heavy layout}\par
\vspace{0.2em}
{\footnotesize Profile slug: journal-of-fluid-mechanics \quad Family: cambridge \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
