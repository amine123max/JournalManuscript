...
\begin{document}
\begin{center}
{\LARGE\bfseries Robotica}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Traditional journal layout with formal sectioning}\par
\vspace{0.2em}
{\footnotesize Profile slug: robotica \quad Family: cambridge \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
