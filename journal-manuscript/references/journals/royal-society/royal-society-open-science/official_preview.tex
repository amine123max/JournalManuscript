...
\begin{document}
\begin{center}
{\LARGE\bfseries Royal Society Open Science}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Open-science format with publication statements}\par
\vspace{0.2em}
{\footnotesize Profile slug: royal-society-open-science \quad Family: royal-society \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
