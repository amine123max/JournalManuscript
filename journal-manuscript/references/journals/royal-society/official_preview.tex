...
\begin{document}
\begin{center}
{\LARGE\bfseries Royal Society Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for Royal Society Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: royal-society \quad Family: royal-society \quad Scope: Family baseline}
\end{center}
\vspace{0.2em}
\noindent{\color{purple!55!black}\bfseries Article Type:} Placeholder Research Article\par\vspace{0.4em}
