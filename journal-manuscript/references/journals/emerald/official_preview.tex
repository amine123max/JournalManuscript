...
\begin{document}
\begin{center}
{\LARGE\bfseries Emerald Family}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Family baseline preview for Emerald Family}\par
\vspace{0.2em}
{\footnotesize Profile slug: emerald \quad Family: emerald \quad Scope: Family baseline}
\end{center}
\vspace{0.2em}
\noindent{\color{green!55!black}\bfseries Article Type:} Placeholder Research Article\par\vspace{0.4em}
