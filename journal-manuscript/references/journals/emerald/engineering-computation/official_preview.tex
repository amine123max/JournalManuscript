...
\begin{document}
\begin{center}
{\LARGE\bfseries Engineering Computation}\par
\vspace{0.25em}
{\small Journal Manuscript Preview Library}\par
\vspace{0.15em}
{\footnotesize Applied journal format with article metadata}\par
\vspace{0.2em}
{\footnotesize Profile slug: engineering-computation \quad Family: emerald \quad Scope: Specific journal profile}
\end{center}
\vspace{0.2em}
